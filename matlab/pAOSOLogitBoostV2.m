classdef pAOSOLogitBoostV2
  ...
  methods
    ...
    function tree_node_cc = get_cc(obj)
      NumIter = pAOSOLogitBoostV2_mex('get',obj.ptr);
      for i = 1 : NumIter
        tree_node_cc{i} = ...
          pAOSOLogitBoostV2_mex('get_cc',obj.ptr, i); %#ok<AGROW>
      end
    end
    ...
    function tree_node_sc = get_sc(obj)
      ...
      for i = 1 : NumIter
        tree_node_sc{i} = ...
          pAOSOLogitBoostV2_mex('get_sc',obj.ptr, i); %#ok<AGROW>
      end
    end    
    ...
    function tree_is_leaf = get_is_leaf(obj)
      ...
      for i = 1 : NumIter
        tree_is_leaf{i} = ...
          pAOSOLogitBoostV2_mex('get_is_leaf',obj.ptr, i); %#ok<AGROW>
      end % for i
    end % get_is_leaf    

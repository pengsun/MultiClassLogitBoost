...
#include "./../../src/pVbExtSamp14VTLogitBoost.hpp"
#include "utilCPP.h"
#include <cstring>

// typedef for booster
typedef pVbExtSamp14VTLogitBoost booster_t;

namespace {
  
}

// h = train(dummy, X,Y, var_cat_mask, T,J,v, node_size, rs,rf,rc, wrs,wrc);

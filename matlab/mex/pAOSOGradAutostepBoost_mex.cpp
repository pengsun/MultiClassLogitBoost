...
#include "./../../src/pAOSOGradAutostepBoost.hpp"
#include "utilCPP.h"
#include <cstring>

// typedef for booster
typedef pAOSOGradAutostepBoost booster_t;
...
void mexFunction(int nlhs,mxArray *plhs[], int nrhs,const mxArray *prhs[]) 
{
  ...
  if ( 0 == strcmp(str,"train") ) {
    ...
    mexErrMsgTxt("pAOSOGradAutostepBoost_mex::unknown option.");
  }
}

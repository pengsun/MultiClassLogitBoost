...
#include "./../../src/pAOSOLogitBoostV2Vb.hpp"
#include "utilCPP.h"
#include <cstring>

// typedef for booster
typedef pAOSOLogitBoostV2Vb booster_t;
...
// [si_to_leaf] = get_si_to_leaf(dummy, h, itree);
void get_si_to_leaf(int nlhs,mxArray *plhs[], int nrhs,const mxArray *prhs[]) 
{
  /* Input */
  // get pointer
  double *ptmp = (double*)mxGetData(prhs[1]);
  ...
  // retrieve 
  VecInt si_to_leaf;
  pbooster->get_si_to_leaf(itree, si_to_leaf);

  ...
  methods
    ...
    function [NumIter, TrLoss,F,P,tree,...
      ...
      [NumIter, TrLoss, F,P, GradCls,LossCls] =...
        pAOSOMARTVb_mex('get',obj.ptr);
      tree = 0;
    end    
    
    function tree_node_cc = get_cc(obj)
      NumIter = pAOSOMARTVb_mex('get',obj.ptr);
      for i = 1 : NumIter
        tree_node_cc{i} = ...
          pAOSOMARTVb_mex('get_cc',obj.ptr, i); %#ok<AGROW>
      end
    end
    ...
    function tree_node_sc = get_sc(obj)
      ...
      for i = 1 : NumIter
        tree_node_sc{i} = ...
          pAOSOMARTVb_mex('get_sc',obj.ptr, i); %#ok<AGROW>
      end
    end    
    ...
    function tree_is_leaf = get_is_leaf(obj)
      ...
      for i = 1 : NumIter
        tree_is_leaf{i} = ...
          pAOSOMARTVb_mex('get_is_leaf',obj.ptr, i); %#ok<AGROW>
      end % for i
    end % get_is_leaf    
    ...
    function tree_si_to_leaf = get_si_to_leaf(obj)
      ...
      for i = 1 : NumIter
        tree_si_to_leaf{i} = ...
          pAOSOMARTVb_mex('get_si_to_leaf',obj.ptr, i); %#ok<AGROW>
      end % for i
    end % get_is_leaf    
    ...
    function pp = get_pp(obj)
      ...
      for i = 1 : NumIter
        pp{i} = ...
          pAOSOMARTVb_mex('get_pp',obj.ptr, i); %#ok<AGROW>
      end % for i
    end % get_pp
    
    function Y = predict(obj, X, T)
      if (nargin==2) 
        T = pAOSOMARTVb_mex('get',obj.ptr);
      end
      Y = pAOSOMARTVb_mex('predict',obj.ptr, X, T);
    end
    
    function delete(obj)
      pAOSOMARTVb_mex('delete',obj.ptr);
    end
  end % method

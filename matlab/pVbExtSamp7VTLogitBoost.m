classdef pVbExtSamp7VTLogitBoost
  ...
  methods
    function obj = train(obj,X,Y, varargin)
      ...
      obj.ptr = pVbExtSamp7VTLogitBoost_mex('train',...
        X,Y,var_cat_mask,...
        T, J, v,...
        node_size,...
        rs,rf,rc);
    ...
    function [NumIter, TrLoss,F,P,tree, nr_wts,nr_wtc] = get (obj)
      [NumIter, TrLoss, F,P, nr_wts,nr_wtc] =...
        pVbExtSamp7VTLogitBoost_mex('get',obj.ptr);
      tree = 0;
    end
    
    function Y = predict(obj, X, T)
      if (nargin==2) 
        T = pVbExtSamp7VTLogitBoost_mex('get',obj.ptr);
      end
      Y = pVbExtSamp7VTLogitBoost_mex('predict',obj.ptr, X, T);
    end
    
    function delete(obj)
      pVbExtSamp7VTLogitBoost_mex('delete',obj.ptr);
    end
  end % method

classdef pVbExtSamp11VTLogitBoost
  ...
  methods
    function obj = train(obj,X,Y, varargin)
      ...
      obj.ptr = pVbExtSamp11VTLogitBoost_mex('train',...
        X,Y,var_cat_mask,...
        T, J, v,...
        node_size,...
        rs,rf,rc);
    ...
    function [NumIter, TrLoss,F,P,tree, nr_wts,nr_wtc] = get (obj)
      [NumIter, TrLoss, F,P, nr_wts,nr_wtc] =...
        pVbExtSamp11VTLogitBoost_mex('get',obj.ptr);
      tree = 0;
    end
    
    function tree_node_cc = get_cc(obj)
      NumIter = pVbExtSamp11VTLogitBoost_mex('get',obj.ptr);
      for i = 1 : NumIter
        tree_node_cc{i} = ...
          pVbExtSamp11VTLogitBoost_mex('get_cc',obj.ptr, i); %#ok<AGROW>
      end
    end
    ...
    function tree_node_sc = get_sc(obj)
      ...
      for i = 1 : NumIter
        tree_node_sc{i} = ...
          pVbExtSamp11VTLogitBoost_mex('get_sc',obj.ptr, i); %#ok<AGROW>
      end
    end    
    
    function Y = predict(obj, X, T)
      if (nargin==2) 
        T = pVbExtSamp11VTLogitBoost_mex('get',obj.ptr);
      end
      Y = pVbExtSamp11VTLogitBoost_mex('predict',obj.ptr, X, T);
    end
    
    function delete(obj)
      pVbExtSamp11VTLogitBoost_mex('delete',obj.ptr);
    end
  end % method

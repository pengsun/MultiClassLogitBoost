classdef pGSExtSamp2VTLogitBoost
  ...
  methods
    function obj = train(obj,X,Y, varargin)
      ...
      obj.ptr = pGSExtSamp2VTLogitBoost_mex('train',...
        X,Y,var_cat_mask,...
        T, J, v,...
        node_size,...
        rs,rf,rc);
    ...
    function [NumIter, TrLoss,F,P,tree] = get (obj)
      [NumIter, TrLoss, F,P] = pGSExtSamp2VTLogitBoost_mex('get',obj.ptr);
      tree = 0;
    end
    
    function Y = predict(obj, X, T)
      if (nargin==2) 
        T = pGSExtSamp2VTLogitBoost_mex('get',obj.ptr);
      end
      Y = pGSExtSamp2VTLogitBoost_mex('predict',obj.ptr, X, T);
    end
    
    function delete(obj)
      pGSExtSamp2VTLogitBoost_mex('delete',obj.ptr);
    end
  end % method
